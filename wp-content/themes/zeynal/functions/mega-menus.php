	...
	<div class="tie-mega-menu-type">
		...
		<p class="field-megamenu-image description description-wide">
			...
			<select id="edit-menu-item-megamenu-position-<?php echo $item_id; ?>" class="widefat code edit-menu-item-megamenu-position" name="menu-item-tie-megamenu-position[<?php echo $item_id; ?>]">
				<option value="center" <?php selected( $item->tie_megamenu_position, 'center' ); ?>>وسط</option>
				<option value="right" <?php selected( $item->tie_megamenu_position, 'right' ); ?>>راست</option>
				<option value="left" <?php selected( $item->tie_megamenu_position, 'left' ); ?>>چپ</option>
			</select>
			<select id="edit-menu-item-megamenu-position-y-<?php echo $item_id; ?>" class="widefat code edit-menu-item-megamenu-position-y" name="menu-item-tie-megamenu-position-y[<?php echo $item_id; ?>]">
				<option value="center" <?php selected( $item->tie_megamenu_position_y, 'center' ); ?>>وسط</option>
				<option value="top" <?php selected( $item->tie_megamenu_position_y, 'top' ); ?>>بالا</option>
				<option value="bottom" <?php selected( $item->tie_megamenu_position_y, 'bottom' ); ?>>پایین</option>
			</select>
			<select id="edit-menu-item-megamenu-repeat-<?php echo $item_id; ?>" class="widefat code edit-menu-item-megamenu-repeat" name="menu-item-tie-megamenu-repeat[<?php echo $item_id; ?>]">
				<option value="no-repeat" <?php selected( $item->tie_megamenu_repeat, 'no-repeat' ); ?>>بدون تکرار</option>
				<option value="repeat" <?php selected( $item->tie_megamenu_repeat, 'repeat' ); ?>>تکرار</option>
				<option value="repeat-x" <?php selected( $item->tie_megamenu_repeat, 'repeat-x' ); ?>>تکرار نوع 1</option>
				<option value="repeat-y" <?php selected( $item->tie_megamenu_repeat, 'repeat-y' ); ?>>تکرار نوع 2</option>
			</select>
		</p>
