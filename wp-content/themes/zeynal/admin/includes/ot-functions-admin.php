          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'تنظیمات پوسته', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'تنظیمات پوسته', 'option-tree' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', __( 'تنظیمات پوسته بروزرسانی شد.', 'option-tree' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', __( 'تنظیمات پوسته ریست شد.', 'option-tree' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', __( 'ذخیره تنظیمات', 'option-tree' ) ),
