<?php
/**
 * Plugin Name: دکان پرو|استارتر
 * Plugin URI: https://zhaket.com/product/dokan-pro/
 * Description: افزونه ایجاد چندفروشندگی ووکامرس
 * Version: 3.5.2
 * Author: Redwp
 * Author URI: https://redwp.ir/
...
dokan_pro();
add_filter( 'plugin_row_meta', 'add_link_dokan', 10, 2 );

function add_link_dokan( $links, $file ) {
...
function dokan_pro_filter_plugin_updates( $value ) {
    unset( $value->response['dokan-pro/dokan-pro.php'] );
    return $value;
}
add_filter( 'site_transient_update_plugins', 'dokan_pro_filter_plugin_updates' ,11 , 1);