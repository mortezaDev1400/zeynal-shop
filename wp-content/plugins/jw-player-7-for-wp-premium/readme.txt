...
* Enhancement : New API v2 authentication with Site ID and Secret  
* Enhancement : New API v2 endpoints 
* Enhancement : Full list of ad partners available for player bidding option
* Enhancement : Price range options for Google Ad Manager mediation 
* Enhancement : GDPR options 
* Enhancement : CCPA options 
...
* Bug: First video disappears in some cases
