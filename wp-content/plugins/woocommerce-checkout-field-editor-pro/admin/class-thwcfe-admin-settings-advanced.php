...
class THWCFE_Admin_Settings_Advanced extends THWCFE_Admin_Settings{
	...
	public function get_advanced_settings_fields(){
		$fields_position_email = array(
			'woocommerce_email_order_meta_fields' => 'بالاتر از مشخصات مشتری',
			'woocommerce_email_customer_details_fields' => 'در زیر جزئیات مشتری',
		);
		...
		return array(
			'custom_fields_position_email' => array(
				'name'=>'custom_fields_position_email', 'label'=>'نمایش موقعیت فیلد ها در ایمیل', 'type'=>'select', 
				'value'=>'woocommerce_email_order_meta_fields', 'options'=>$fields_position_email
			),	
			'custom_shop_order_columns' => array(
				'name'=>'custom_shop_order_columns', 'label'=>'ستون سفارش فروشگاه سفارشی', 'type'=>'multiselect_grouped', 'options'=>$custom_fields, 'glue'=>':'
			),	
			'section_address_fields' => array('title'=>'قسمتهای آدرس سفارشی', 'type'=>'separator', 'colspan'=>'3'),
			'custom_billing_address_keys' => array(
				'name'=>'custom_billing_address_keys', 'label'=>'کلیدهای آدرس صورتحساب سفارشی', 'type'=>'multiselect', 'options'=>$custom_billing_fields
			),
			'custom_shipping_address_keys' => array(
				'name'=>'custom_shipping_address_keys', 'label'=>'کلیدهای آدرس حمل و نقل سفارشی', 'type'=>'multiselect', 'options'=>$custom_shipping_fields
			),
			'address_formats' => array('name'=>'address_formats', 'label'=>'قالب آدرس نادیده گرفته می شود', 'type'=>'textarea'),
			'section_custom_validators' => array('title'=>'اعتبارسنج های سفارشی', 'type'=>'separator', 'colspan'=>'3'),
			'custom_validators' => array(
				'name'=>'custom_validators', 'label'=>'اعتبارسنج های سفارشی', 'type'=>'dynamic_options'
			),
			'confirm_validators' => array(
				'name'=>'confirm_validators', 'label'=>'تایید رشته اعتبارسنج', 'type'=>'dynamic_options', 'prefix'=>'cnf'
			),
			'section_csv_export' => array('title'=>'برون ریزی زمینه ها csv', 'type'=>'separator', 'colspan'=>'3'),
			'enable_csv_export_support' => array(
				'name'=>'enable_csv_export_support', 'label'=>'پشتیبانی از برون ریزی CSV را فعال کنید.', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'csv_export_columns' => array(
				'name'=>'csv_export_columns', 'label'=>'ستون های برون ریزی csv', 'type'=>'multiselect_grouped', 'options'=>$custom_fields
			),
			'section_pdf_invoice' => array('title'=>'زمینه های برگه فاکتور و بسته بندی PDF', 'type'=>'separator', 'colspan'=>'3'),
			'enable_wcpdf_invoice_packing_slip_support' => array(
				'name'=>'enable_wcpdf_invoice_packing_slip_support', 'label'=>'فعال کردن فاکتور pdfو پشتیبانی بسته بندی', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'pdf_invoice_fields' => array(
				'name'=>'pdf_invoice_fields', 'label'=>'زمینه های فاکتور', 'type'=>'multiselect_grouped', 'options'=>$custom_fields
			),
			'pdf_packing_slip_fields' => array(
				'name'=>'pdf_packing_slip_fields', 'label'=>'بسته بندی اسلیپ فیلد', 'type'=>'multiselect_grouped', 'options'=>$custom_fields
			),

			'locale_override_settings' => array('title'=>'نادیده گرفتن تنظیمات محلی', 'type'=>'separator', 'colspan'=>'3'),
			'enable_autofill' => array('name'=>'enable_autofill', 'label' => 'تکمیل خودکار آدرس را فعال کنید', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0),
			'autofill_apikey' => array('type'=>'text', 'name'=>'autofill_apikey', 'label'=>'کلید Google Maps API','value'=> ''),


			'locale_override_settings' => array('title'=>'لغو تنظیمات محلی', 'type'=>'separator', 'colspan'=>'3'),
			'enable_label_override' => array(
				'name'=>'enable_label_override', 'label'=>'لغو برچسب را برای قسمتهای آدرس فعال کنید.', 'type'=>'checkbox', 'value'=>'1', 'checked'=>1
			),
			'enable_placeholder_override' => array(
				'name'=>'enable_placeholder_override', 'label'=>'لغو نگهدارنده مکان را برای فیلدهای آدرس فعال کنید.', 'type'=>'checkbox', 'value'=>'1', 'checked'=>1
			),
			'enable_class_override' => array(
				'name'=>'enable_class_override', 'label'=>'لغو کلاس را برای فیلدهای آدرس فعال کنید.', 'type'=>'checkbox', 'value'=>'1', 'checked'=>0
			),
			'enable_priority_override' => array(
				'name'=>'enable_priority_override', 'label'=>'لغو اولویت را برای قسمتهای آدرس فعال کنید.', 'type'=>'checkbox', 'value'=>'1', 'checked'=>1
			),
			'enable_required_override' => array(
				'name'=>'enable_required_override', 'label'=>'لغو اعتبار مورد نیاز را برای فیلدهای آدرس فعال کنید.', 'type'=>'checkbox', 'value'=>'1', 'checked'=>0
			),
			'section_other_settings' => array('title'=>'سایر تنظیمات', 'type'=>'separator', 'colspan'=>'3'),
			...
			'enable_conditions_country' => array(
				'name'=>'enable_conditions_country', 'label'=>'بر اساس قوانین مشروط ، نمایش قسمت کشور را فعال کنید.', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'enable_conditions_state' => array(
				'name'=>'enable_conditions_state', 'label'=>'نمایش استان /  براساس قوانین مشروط را فعال کنید.', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'enable_country_based_conditions' => array(
				'name'=>'enable_country_based_conditions', 'label'=>'قوانین مشروط را براساس کشور انتخاب شده فعال کنید.', 
				'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'enable_conditions_payment_shipping' => array(
				'name'=>'enable_conditions_payment_shipping', 'label'=>'قوانین مشروط را براساس روش پرداخت و حمل و نقل فعال کنید.', 
				'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'enable_conditions_review_panel' => array(
				'name'=>'enable_conditions_review_panel', 'label'=>'قوانین مشروط را برای صفحه بررسی فعال کنید.', 
				'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'disable_select2_for_select_fields' => array(
				'name'=>'disable_select2_for_select_fields', 'label'=>'"انتخاب پیشرفته (انتخاب 2)" را برای قسمتهای انتخاب غیرفعال کنید.', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'enable_wc_zapier_support' => array(
				'name'=>'enable_wc_zapier_support', 'label'=>'پشتیبانی از زاپیر را فعال کنید.', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'wrap_custom_sections_with_div' => array(
				'name'=>'wrap_custom_sections_with_div', 'label'=>'بسته بندی  سفارشی بخش ها div', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
			'enable_html_in_emails' => array(
				'name'=>'enable_html_in_emails', 'label'=>'نمایش عنوان زمینه / برچسب را در ایمیل ها فعال کنید.', 'type'=>'checkbox', 'value'=>'yes', 'checked'=>0
			),
		);
	}
	...
	private function save_settings(){
		...
		if ($result == true) {
			echo '<div class="updated"><p>'. THWCFE_i18n::t('تغییرات شما ذخیره شد.') .'</p></div>';
		} else {
	...
	private function output_content(){
        ...
        <div style="padding-left: 30px;">               
		    <form id="advanced_settings_form" method="post" action="">
                ...
                <p class="submit">
					<input type="submit" name="save_settings" class="button-primary" value="ذخیره تغییرات">
                    <input type="submit" name="reset_settings" class="button" value="برگشت به حالت پیش فرض" onclick="return confirm('Are you sure you want to reset to default settings? all your changes will be deleted.');">
            	</p>
            </form>
    	</div>       
    	<?php
	...
	public function render_validator_row($settings, $field, $validator = false){
		...
		$pattern_ph = 'الگوی اعتبار سنجی';
		
		if(isset($field['prefix']) && $field['prefix'] === 'cnf'){
			$prefix_index = 1;
			$pattern_ph = 'نام زمینه';
		}
		...
		<tr>
			<td style="width:190px;">
				<input type="text" name="<?php echo $prefix ?>validator_name[]" value="<?php echo $vname; ?>" placeholder="نام اعتبارسنج" style="width:180px;"/>
			</td>
			<td style="width:190px;">
				<input type="text" name="<?php echo $prefix ?>validator_label[]" value="<?php echo $vlabel; ?>" placeholder="برچسب اعتبارسنج" style="width:180px;"/>
			</td>
			<td style="width:190px;">
			...
			<td style="width:190px;">
				<input type="text" name="<?php echo $prefix ?>validator_message[]" value="<?php echo $vmessage; ?>" placeholder="پیام اعتبارسنجی" style="width:180px;"/>
			</td>
			<td class="action-cell">
				<a href="javascript:void(0)" onclick="thwcfeAddNewValidatorRow(this, <?php echo $prefix_index; ?>)" class="dashicons dashicons-plus" title="اعتبار سنج جدید اضافه کنید"></a>
			</td>
			<td class="action-cell">
				<a href="javascript:void(0)" onclick="thwcfeRemoveValidatorRow(this, <?php echo $prefix_index; ?>)" class="dashicons dashicons-no-alt" title="اعتبار سنج را حذف کنید"></a>
			</td>
		</tr>
		<?php
	}
	...
	************************************************/
	...
	public function output_import_export_settings(){
		...
		$imp_exp_fields = array(
			'section_import_export' => array('title'=>'پشتیبان گیری و وارد کردن تنظیمات', 'type'=>'separator', 'colspan'=>'3'),
			'settings_data' => array(
				'name'=>'settings_data', 'label'=>'تنظیمات پلاگین داده ها', 'type'=>'textarea',
				'sub_label'=>'با کپی کردن متن داخل جعبه متن ، می توانید داده های تنظیمات ذخیره شده را بین نصب های مختلف منتقل کنید. برای وارد کردن داده ها از نصب دیگر ، داده های موجود در جعبه متن را با یکی از نصب های دیگر جایگزین کنید و "ذخیره تنظیمات" را کلیک کنید.',
		...
		<div style="padding-left: 30px;">               
		    <form id="import_export_settings_form" method="post" action="" class="clear">
                ...
                <p class="submit">
					<input type="submit" name="save_plugin_settings" class="button-primary" value="ذخیره کردن تنظیمات">
