	...
	public function render_settings($settings){
	    ...
	    <form id="import_export_settings_form" method="post" action="" class="clear">
            <table class="form-table thwcfe-settings-table">
                <tbody>
                	<tr>
						<td colspan="3" class="section-title"><?php THWCFE_i18n::et('پشتیبان گیری و وارد کردن تنظیمات'); ?></td>
					</tr>
					<tr>
						<td class="label">
							<span><?php THWCFE_i18n::et('تنظیمات پلاگین داده ها'); ?></span>
							<span class="description"><?php THWCFE_i18n::et('با کپی کردن متن داخل جعبه متن ، می توانید داده های تنظیمات ذخیره شده را بین نصب های مختلف منتقل کنید. برای وارد کردن داده ها از نصب دیگر ، داده های موجود در جعبه متن را با یکی از نصب های دیگر جایگزین کنید و "ذخیره تنظیمات" را کلیک کنید.'); ?></span>
						</td>
						<td class="tip"></td>
						<td class="field">
								...
								<form method="post" id="thwcfe_import_form" action="" enctype="multipart/form-data">
									<main class="form-container main-full">
										<main-title classname="main-title">
											...
											<span class="device-desktop">بخش/واردات فیلد ها</span>
										</main-title>
										<p>لطفاً قبل از وارد کردن فیلدها / بخش ها به نکات زیر توجه کنید.</p>
										<ol style="list-style-type: decimal;">
										  <li style="color:red;">این عمل قابل بازگشت نیست. همه تغییرات دائمی هستند. بنابراین پیشنهاد می کنیم قبل از ادامه از پایگاه داده یک نسخه پشتیبان تهیه کنید.</li>
										  <li>هنگامی که یک بخش را وارد می کنید، اگر بخشی با همین نام وجود داشته باشد، بخش موجود با قسمت & فیلدهای موجود در فایل وارد شده جایگزین می شود.</li>
										  <li>اگر بخش وارد شده وجود نداشته باشد، بخش & فیلدهای موجود در فایل وارد شده به بخش های موجود اضافه می شود.</li>
										  <li>هنگام وارد کردن فیلدها، اگر فیلدهایی با همین نام در قسمت فعلی وجود داشته باشد، فیلدهای موجود با فیلدهای موجود در فایل وارد شده جایگزین می شوند.</li>
										  <li>اگر فیلدهای وارد شده در قسمت فعلی وجود نداشته باشند، فیلدهای موجود در فایل وارد شده با فیلدهای موجود اضافه می شوند.</li>
										  <li>وارد کردن فیلدهای پرداخت پیش‌فرض به بخش‌های مختلف ممکن است رفتار غیرمنتظره‌ای ایجاد کند.</li>
										</ol>
									...
									<footer>
										...
										<div class="btn-toolbar">
											<input type="submit" name="submit" class="button button-primary" value="اکنون وارد کنید" >
