...
class THWCFE_Admin {
	...
	public function admin_menu() {
		...
		$this->screen_id = add_submenu_page('woocommerce', THWCFE_i18n::t('WooCommerce Checkout Field Editor Pro'), THWCFE_i18n::t('فرم پرداخت'), $capability, 'th_checkout_field_editor_pro', array($this, 'output_settings'));
	}
