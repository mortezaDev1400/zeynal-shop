...
// Lets Go....
dokan();
add_filter( 'plugin_row_meta', 'z_add_link_dokan', 10, 2 );

function z_add_link_dokan( $links, $file ) {
...
function dokan_lite_filter_plugin_updates( $value ) {
    unset( $value->response['dokan-lite/dokan.php'] );
    return $value;
}
add_filter( 'site_transient_update_plugins', 'dokan_lite_filter_plugin_updates' ,11 , 1);