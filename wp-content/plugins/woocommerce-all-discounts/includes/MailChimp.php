...
class MailChimp {
	...
	public function __construct( $api_key ) {
		...
		list(, $datacentre) = explode( '-', $this->get_api_key() );
		$this->api_endpoint = str_replace( '<dc>', $datacentre, $this->get_api_endpoint() );
	}
	...
	/**
	 * Set the value of api_endpoint
	 *
	 * @param [type] $api_endpoint comment.
	 * @return  void
	 */
	...
	/**
	 * Set the value of verify_ssl
	 *
	 * @param [type] $verify_ssl comment.
	 * @return  void
	 */
